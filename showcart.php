...
<li class="nav-item">
        <a class="nav-link active" href="showcart.php">Cart</a>
      </li>
      ...
      ?>
          <tr>
            ...
            <td><?php echo $rows['category_name'] ?></td>
             ...
             <td><button type="button"  class="btn btn-info"><a href="deletefromcart.php?pid= <?php echo $rows['pid']; ?>"class="text-white">Remove</a> </button></td>
          </tr>
